...
class CreationBoxCoffretAction
{
    ...
    {
        $this->template = 'pages/CreationBoxCoffret.twig';
    ...
    public function __invoke(Request $request, Response $response, array $args): Response
    {
        if($request->getMethod() === 'POST') {
            ...
            $coffretId = $params['coffret_id'] ?? null;
            ...
            // Créer la box
            try {
                $boxid = $this->boxManagement->createBoxCoffret($user['id'], $boxName, $boxDescription, $isGift, $coffretId, $gift);
            ...
            if($id == null) {
                throw new \Slim\Exception\HttpBadRequestException($request, "Paramètre manquant : ID de la box.");
            }
